...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/oaOvertime/form?id=${oaOvertime.id}">加班申请</a></li>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="oaOvertime" action="${ctx}/oa/oaOvertime/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="degree" items="${fns:getDictList('degree')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="timeLong" htmlEscape="false" maxlength="12" class="input-small required"/> 时
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
